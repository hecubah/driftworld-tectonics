...
\title{Driftworld 1.0: an overview}
...
\input{sections/SphericalGeometry}
\input{sections/SimpleTectonicModel}
\input{sections/ImplementationDataModel}
...
\newpage
\appendix
\input{sections/ProjectParameters}
